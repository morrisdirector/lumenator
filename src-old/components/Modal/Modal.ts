		...
		<div class="modal-col">
			<div class="modal">
				...
				<div class="modal-body">
					<slot></slot>
					<ui-loader loading="false" class="modal-loader" variant="container"></ui-loader>
				</div>
...
class Modal extends CustomElement {
  constructor() {
    ...
    this.setState({
      ...
      minHeight: this.getAttribute("minHeight")
        ? this.getAttribute("minHeight") + "px"
        : null,
    } as IModalProps);
  }
  ...
  connectedCallback() {
    this.shadowRoot
      .getElementById("lum-modal")
      .addEventListener("click", this.onDimmerClick);
    this.shadowRoot
